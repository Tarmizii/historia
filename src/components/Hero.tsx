    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-20 text-center">
        <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <p className="text-gray-400 uppercase tracking-widest mb-4 font-medium">Studio Fotografi Profesional</p>
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-6 leading-tight">
            <span className="inline-block relative">
              <span className="relative z-10">HISTORIA</span>
              <span className="absolute -bottom-2 left-0 right-0 h-1 bg-gray-400"></span>
            </span>
